...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    welcome_message = 'Hello! I am your Crypto Bot. I can provide real-time data for any cryptocurrency. Use /start /data <crypto-name> to get started. /high_low <crypto-name> /supply /ranks /search_pools.'
